          ...
          children: [
            Column(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text('Login to watch',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold)),
                ),
                Padding(
                  padding: const EdgeInsets.only(left: 30),
                  child: Text('Start watching from where you let off,personalise for kids and more',style: TextStyle(color: Colors.grey,fontSize: 15,),),
                ),
