...
import 'package:ott/ott1.dart';
//import 'package:untitled/ott10.dart';
import 'color.dart';
import 'model.dart';
import 'ott1.dart';
import 'ott10.dart';
    ...
    height:250,
      ...
      itemBuilder: (BuildContext context, int index,int)
      {
                        ...
                        child: SizedBox(height: 50,width: 200,
                          child: ElevatedButton
                            ...
                            children: [Icon(Icons.play_arrow,color: Colors.white,),
                              Text( 'Watch Now',style: TextStyle(color: Colors.white,fontSize: 15),),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text("Latest Releases",style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold),),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text("ICC CWC 2023 and More",style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold),),
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text('Free Newly Added',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text('Free Popular Shows',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
